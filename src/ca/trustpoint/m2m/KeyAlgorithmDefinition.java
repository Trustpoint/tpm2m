...
/**
 * <p>Represents the definition of a key algorithm. It contains the OID of the algorithm and any
 * parameter data needed for using that algorithm with a given key pair. For example the
 * parameter data might be a curve point for and ECC key pair. </p>
 *
 * <p>Note that this object does not represent a distinct ASN.1 object, but rather is an
 * abstraction that is used to represent fields in an ASN.1 sequence such as the TBSCertificate in
 * the M2M spec.</p>
 */
public class KeyAlgorithmDefinition {
    ...
    /**
     * Returns the string representation of the key algorithm definition.
     *
     * @return The string representation of the key algorithm definition.
     */
    public String toString() {
        StringBuilder builder = new StringBuilder();

        builder.append("Algorithm: ").append(toStringAlgorithm());
        builder.append(", ");
        builder.append("Parameters: ").append(toStringParameters());
