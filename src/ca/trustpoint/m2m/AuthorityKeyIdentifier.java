...
public class AuthorityKeyIdentifier {
    ...
    public byte[] getEncoded() throws IOException {
        ...
        if (certificateIssuer != null) {
            ASN1TaggedObject encodedIssuer =
                    DERTaggedObject.getInstance(certificateIssuer.getEncoded());
    ...
    public String toString(int depth) {
        ...
        if (certificateSerialNumber != null) {
            FormattingUtils.indent(buffer, depth + 1).append(
                    "[2] authCertSerialNum OCTET STRING: ");
            buffer.append(Hex.toHexString(
                    certificateSerialNumber.toByteArray())).append(LINE_SEPARATOR);
        }
