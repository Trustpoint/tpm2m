...
public class KeyConversionUtils {
    ...
    /*
     * Reurns publickey compression status with the given key raw data.
     *
     * @param rawPoint Publickey raw data.
     *
     * @return True if the publickey is compressed, otherwise false.
     * @throws InvalidKeyException if public EC point type is unknown.
     */
        ...
        switch (rawPoint[0]) {
            ...
            default:
                throw new InvalidKeyException(
                    "unrecognized public EC point type: (" + rawPoint[0] + ")");
        }
     ...
     *
     * @throw InvalidKeyException if key type or length is unrecognized.
     * @throw IOException if raw data reading error.
     */
     ...
     * @param withCompression True if the output should be the compressed representation of the
     *        point.
