...
public enum EntityNameAttributeId {
    ...
    /**
     * Country code. Only
     * <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO 3166-1 alpha-2</a> codes are
    ...
    /**
     * Distinguished Name Qualifier. Value may be 1 to 32 ASN.1 PrintableString characters in
     * length.
     */
    ...
    /**
     * Domain Component as defined in
     * <a href="https://tools.ietf.org/html/rfc4519#section-2.4">RFC 4519</a>.
     * Value may be 1 to 32 ASN.1 IA5String characters in length.
     */
    DomainComponent(8),
