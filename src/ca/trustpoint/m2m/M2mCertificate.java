...
public class M2mCertificate extends Certificate implements X509Extension {
    ...
    private static class Extension {
        ...
        public ASN1EncodableVector getEncoded() {
            ...
            sequenceValues.add(
                    new DERTaggedObject(false, 0, new ASN1ObjectIdentifier(oid)));

            if (isCritical) { // Default value is false, so only encode the field if true.
                sequenceValues.add(
                        new DERTaggedObject(false, 1, ASN1Boolean.getInstance(isCritical)));
            }

            sequenceValues.add(
                    new DERTaggedObject(false, 2, new DEROctetString(value)));
     ...
     *
     * This is not simply the number twenty.
     * The APPLICATION tag has a spec (X.690 section 8.1.2.2)
     * It consists of 8 bits: [ 8 7 6 5 4 3 2 1 ]
     * [ 8 7 ] = [ 0 1 ] - Specifies the APPLICATION type (there are other types)
     * [ 6 ] = [ 1 ] - We are not encoding a primitive object
     * [ 5 4 3 2 1 ] = [ 1 0 1 0 0 ] - integer 20 in binary
     *
     * The result is [ 0 1 1 1 0 1 0 0 ] = 0x74
     *
     * However since Bouncy Castle takes care of the top three bits
     * we only have to pass in the number 20.
     */
    ...
    public byte[] getTBSCertificate() throws IOException {
         ...
         * elements.add(
         *     new DERTaggedObject(
         *         false, TbsCertificateFields.VERSION.getTagNumber(), new ASN1Integer(VERSION)));
         */
        elements.add(
            new DERTaggedObject(
                false,
                TbsCertificateFields.SERIAL_NUMBER.getTagNumber(),
        ...
        if (caKeyDefinition != null) {
            if (caKeyDefinition.getAlgorithm() != null) {
                elements.add(
                    new DERTaggedObject(
                        false,
                        TbsCertificateFields.CA_ALGORITHM.getTagNumber(),
            ...
            if (caKeyDefinition.getParameters() != null) {
                elements.add(
                    new DERTaggedObject(
                        false,
                        TbsCertificateFields.CA_ALGORITHM_PARAMETERS.getTagNumber(),
        ...
        if (issuer != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.ISSUER.getTagNumber(),
        ...
        if (validFrom != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.VALID_FROM.getTagNumber(),
                    // We record seconds, not milliseconds, hence the / 1000
                    new DEROctetString(
                        BigInteger.valueOf(validFrom.getTime() / 1000).toByteArray())));
        }
        ...
        if (validDuration != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.VALID_DURATION.getTagNumber(),
                    new DEROctetString(
                        BigInteger.valueOf(validDuration.intValue()).toByteArray())));
        }

        elements.add(
            new DERTaggedObject(
                false,
                TbsCertificateFields.SUBJECT.getTagNumber(),
        ...
        if (publicKeyDefinition != null) {
            if (publicKeyDefinition.getAlgorithm() != null) {
                elements.add(
                    new DERTaggedObject(
                        false,
                        TbsCertificateFields.PUBLIC_KEY_ALGORITHM.getTagNumber(),
        ...
        if (publicKey != null) {
            ...
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.PUBLIC_KEY.getTagNumber(),
        ...
        if (authorityKeyIdentifier != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.AUTHORITY_KEY_ID.getTagNumber(),
        ...
        if (subjectKeyIdentifier != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.SUBJECT_KEY_ID.getTagNumber(),
        ...
        if (keyUsage != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.KEY_USAGE.getTagNumber(),
        ...
        if (basicConstraints != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.BASIC_CONSTRAINTS.getTagNumber(),
        ...
        if (certificatePolicy != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.CERTIFICATE_POLICY.getTagNumber(),
        ...
        if (subjectAlternativeName != null) {
            elements.add(
                new DERTaggedObject(
                    true,
                    TbsCertificateFields.SUBJECT_ALTERNATE_NAME.getTagNumber(),
        ...
        if (issuerAlternativeName != null) {
            elements.add(
                new DERTaggedObject(
                    true,
                    TbsCertificateFields.ISSUER_ALTERNATE_NAME.getTagNumber(),
        ...
        if (extendedKeyUsage != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.EXTENDED_KEY_USAGE.getTagNumber(),
        ...
        if (crlDistributionPointUri != null) {
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.CRL_DISTRIBUTION_POINT_URI.getTagNumber(),
        ...
        if (!extensions.isEmpty()) {
            ...
            elements.add(
                new DERTaggedObject(
                    false,
                    TbsCertificateFields.EXTENSIONS.getTagNumber(),
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        ...
        if (!isTbsCertificateValid()) {
            ...
            throw new CertificateEncodingException(
                "Signature or reconstruction value must be present.");
        }
        ...
        try {
            elements.add(
                new DERTaggedObject(
                    false,
                    CertificateFields.TBS_CERTIFICATE.getTagNumber(),
        ...
        elements.add(
            new DERTaggedObject(
                false,
                CertificateFields.CA_CALC_VALUE.getTagNumber(),
        ...
        try {
            certificate =
                new DERApplicationSpecific(
                    false, APPLICATION_TAG_NUMBER, new DERSequence(elements));
        } catch (IOException ex) {
    ...
    public M2mCertificateLite getM2mCertificateLite()
        throws CertificateEncodingException, IllegalArgumentException, IOException {
        M2mCertificateLite lite = new M2mCertificateLite();
        lite.setEncoded(getEncoded());
        lite.setTbsEncoded(getTBSCertificate());
        lite.setSignature(getCaCalcValue());

        if (issuer != null) {
            lite.setIssuerX500Principal(issuer.getX500Principal());
        }

        if (caKeyDefinition != null) {
            SignatureAlgorithms sigAlgorithm =
                SignatureAlgorithms.getInstance(caKeyDefinition.getAlgorithm());
            lite.setSignatureAlogorithmBcName(sigAlgorithm.getBouncyCastleName());
            lite.setSignatureAlogorithmOid(caKeyDefinition.getAlgorithm().getOid());
            lite.setSignatureParameters(caKeyDefinition.getParameters());
        }

        lite.setSignatureProvider(BouncyCastleProvider.PROVIDER_NAME);
        lite.setPublicKey(getPublicKey());
        lite.setIsEcqvCertificate(isEcqvCertificate());
        lite.setStringCert(toString());
    ...
    public String toString(int depth) {
        ...
        FormattingUtils.indent(buffer, depth).append(
            "M2MCertificate [APPLICATION 20] SEQUENCE {").append(LINE_SEPARATOR);
        FormattingUtils.indent(buffer, depth + 1).append(
            "[0] tbsCertificate TBSCertificate: ").append(LINE_SEPARATOR);

        FormattingUtils.indent(buffer, depth + 2).append(
            "TBSCertificate SEQUENCE {").append(LINE_SEPARATOR);
        FormattingUtils.indent(buffer, depth + 3).append(
            "[ 0] version INTEGER:               ");
        ...
        if (caKeyDefinition != null) {
            if (caKeyDefinition.getAlgorithm() != null) {
                FormattingUtils.indent(buffer, depth + 3).append(
                    "[ 2] cAAlgorithm OBJECT IDENTIFIER: ");
                buffer.append(caKeyDefinition.getAlgorithm().getOid()).append(LINE_SEPARATOR);
            }

            if (caKeyDefinition.getParameters() != null) {
                FormattingUtils.indent(buffer, depth + 3).append(
                    "[ 3] cAAlgParams OCTET STRING:      ");
                buffer.append(caKeyDefinition.getParameters()).append(LINE_SEPARATOR);
            }
        }

        if (issuer != null) {
            FormattingUtils.indent(buffer, depth + 3).append(
                "[ 4] issuer Name: ").append(LINE_SEPARATOR);
            buffer.append(issuer.toString(depth + 4));
        }

        if (validFrom != null) {
            FormattingUtils.indent(buffer, depth + 3).append(
                "[ 5] validFrom OCTET STRING: ");
            buffer.append(Hex.toHexString(
                BigInteger.valueOf(validFrom.getTime() / 1000).toByteArray())).append(
                    LINE_SEPARATOR);
        }

        if (validDuration != null) {
            FormattingUtils.indent(buffer, depth + 3).append(
                "[ 6] validDuration OCTET STRING: ");
            buffer.append(validDuration).append(LINE_SEPARATOR);
        }

        if (subject != null) {
            FormattingUtils.indent(buffer, depth + 3).append(
                "[ 7] subject Name: ").append(LINE_SEPARATOR);
    ...
    public void verify(PublicKey key, String sigProvider)
        ...
        if (isEcqvCertificate()) { // Implicit certificate.
            ...
            // We need the signature algorithm that was used to sign this certificate. If not
            ...
            try {
                ...
                throw new SignatureException(
                    "unable to generate TBS certificate for verification.", ex);
            }
    ...
    /**
     * Checks that the certificate is currently valid. It is if the current date and time are
        ...
        if (validFrom != null) {
            if (validFrom.after(date)) {
                throw new CertificateNotYetValidException(
                    ...
                    DateFormat.getInstance().format(validFrom) + ".");
            }
            ...
            if (validDuration != null) {
                ...
                if (notAfter.before(date)) {
                    throw new CertificateExpiredException(
                        ...
                        DateFormat.getInstance().format(notAfter) + ".");
                }
            }
        }
    }
    ...
    public PrivateKey reconstructPrivateKey(
        PrivateKey ephemeralPrivateKey, byte[] privateKeyReconstructionData)
        ...
        try {
            EcqvProvider provider = new EcqvProvider(caAlgorithm, caKeyDefinition.getParameters());
            reconstructedKey =
                provider.reconstructPrivateKey(
                    getTBSCertificate(), caCalcValue, privateKeyReconstructionData,
                    ephemeralPrivateKey);
        } catch (Exception ex) {
    ...
    public boolean equals(Object other) {
        ...
        } else if (!authenticationInfoAccessOcsp.equals(
                otherCertificate.getAuthenticationInfoAccessOcsp())) {
            return false;
        }
     ...
     * basic formatting constraints on the fields and any mandatory/optional constraints. The
     * validity of the data stored in these fields would normally be checked by a Certificate
     * Authority (CA) when processing a certificate signing request (CSR).
     *
    ...
    /**
     * Returns the set of extensions defined for this instance that are or are not marked as
     * critical.
     *
     * @param isCritical If true, then the set of extensions defined for this instance that are
     *        marked critical are returned. If false, then the set of extensions marked
     *        non-critical are returned.
    ...
    private void checkIfEcqvCertificate() throws NoSuchAlgorithmException {
        if (caKeyDefinition != null) {
            if (caKeyDefinition.getAlgorithm() != null) {
                try {
                    if (!SignatureAlgorithms.getInstance(
                        caKeyDefinition.getAlgorithm().getOid()).isEcqv()) {
