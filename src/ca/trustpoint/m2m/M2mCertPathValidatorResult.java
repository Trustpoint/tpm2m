 ...
 *
 * <p>Instances of {@code M2mCertPathValidatorResult} are returned by the
 * {@link java.security.cert.CertPathValidator#validate validate()} method of
 * {@link M2mCertPathValidator} objects.
 *
 * <p> All {@code M2mCertPathValidatorResult} objects contain the subject public key resulting from
 * the validation algorithm, as well as a {@link M2mTrustAnchor} describing the certification
...
public class M2mCertPathValidatorResult implements CertPathValidatorResult {
     ...
     *
     * @param trustAnchor a {@link M2mTrustAnchor} describing the CA that served as a trust anchor
     *        for the certification path
     * @param subjectPublicKey the public key of the subject
     * @throws NullPointerException if the {@code subjectPublicKey} or {@code trustAnchor}
