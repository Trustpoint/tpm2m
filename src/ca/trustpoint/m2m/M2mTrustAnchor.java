...
public class M2mTrustAnchor {
     ...
     * @throws IllegalArgumentException if certificate is null or either the subject or public key
     *         are null or invalid.
     */
     ...
     */
    public M2mTrustAnchor(X509Certificate x509Certificate)
        ...
        X500Name x500Name =
            X500Name.getInstance(x509Certificate.getSubjectX500Principal().getEncoded());
        ...
        for (RDN rdn : x500Name.getRDNs()) {
            ...
            if (attributeCount == EntityName.MAXIMUM_ATTRIBUTES) {
                // We have reached the maximum number of attributes for an EntityName, so stop
                // here.
                break;
            }
        }
