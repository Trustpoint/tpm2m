...
public class M2mCertPath extends CertPath {
    ...
    public static enum SupportedEncodings {
         ...
         * {@link java.security.cert.CertPath CertPath} interface. We construct this statically to
         * save work.
         */
         ...
         * @throws IllegalArgumentException If the given ID string does not match an enumeration
         *         value.
         */
     ...
     * should only contain {@link M2mCertificate M2MCertificate} objects. Duplicates are not
     * permitted within the chain.
     *
     ...
     * encoding first.
     * <p>
     * Attempts to modify the returned <code>Iterator</code> via its <code>remove</code> method
